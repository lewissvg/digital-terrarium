...
public class GenomeTests
{
    ...
    {
        var parent = new Genome(Speed: 4f, Metabolism: 1f, SenseRange: 40f, DietType: 0.3f);
    ...
    {
        var tiny = new Genome(Speed: 0.05f, Metabolism: 0.05f, SenseRange: 0.5f, DietType: 0.5f);
    ...
    {
        var parent = new Genome(3f, 1f, 30f, 0.4f);
    ...
    {
        var parent = new Genome(Speed: 4f, Metabolism: 1f, SenseRange: 30f, DietType: 0.5f);
        var rng = new Random(42);
    ...
    {
        var parent = new Genome(4f, 1f, 30f, DietType: 0f);
    ...
    {
        var parent = new Genome(4f, 1f, 30f, DietType: 1f);
        var rng = new Random(0);
