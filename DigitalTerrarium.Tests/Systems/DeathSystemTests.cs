...
public class DeathSystemTests
{
    ...
    {
        Organism alive = Organism.NewBorn(Vector2.Zero, new Genome(1, 1, 1), 0);
        alive.Energy = 10;

        Organism deadA = Organism.NewBorn(Vector2.Zero, new Genome(1, 1, 1), 0);
        deadA.Energy = 0;

        Organism deadB = Organism.NewBorn(Vector2.Zero, new Genome(1, 1, 1), 0);
        deadB.Energy = -3;
